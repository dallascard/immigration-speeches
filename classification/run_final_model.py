...
def main():
    ...
    parser.add_option('--basedir', type=str, default='data/congress/relevance/splits/basic/',
...
def run(basedir, seed=42, model_type='bert', model_name_or_path='bert-base-uncased', tokenizer_name='', lr=2e-5, max_seq_length=400, per_gpu=4, n_epochs=7, train_file='all.jsonlist', output_prefix='all'):
    ...
    if output_prefix is None:
        ...
        output_prefix += '_'
    output_prefix += os.path.basename(model_name_or_path)
