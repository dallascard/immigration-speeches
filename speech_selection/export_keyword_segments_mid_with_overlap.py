...
from speech_selection.query_terms import mid
...
def main():
    ...
    parser.add_option('--outfile', type=str, default='/u/scr/dcard/data/congress/keyword_segments/keyword_segments_70-88.jsonlist',
