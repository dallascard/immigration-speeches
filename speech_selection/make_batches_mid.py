...
def main():
    ...
    parser.add_option('--indir', type=str, default='/u/scr/dcard/data/congress/for_annotation_mid/',
                      help='Input dir: default=%default')
    parser.add_option('--basedir', type=str, default='/u/scr/dcard/data/congress/for_annotation_mid/rounds/',
