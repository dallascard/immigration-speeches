...
def main():
    ...
    parser.add_option('--infile', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/presidential/paragraphs.jsonlist',
                      help='Processed USCR dir: default=%default')
    parser.add_option('--outfile', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/presidential/paragraphs.tokenized.jsonlist',
