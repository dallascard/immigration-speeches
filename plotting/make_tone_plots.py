...
def plot_percent_diff_line_with_bands(ax, numerator1, numerator2, denominator, keys, xvals, color, label, line_alpha=1.0, fill_alpha=0.2, linestyle='-'):
    ...
    ax.plot(xvals, 100 * series, label=label, c=color, linewidth=1, alpha=line_alpha, linestyle=linestyle)
