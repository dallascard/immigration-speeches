...
def main():
    ...
    parser.add_option('--indir', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/hein-bound/',
                      help='Hein bound dir: default=%default')
    parser.add_option('--outdir', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/hein-bound_parsed/',
                      help='Hein bound dir: default=%default')
