...
def main():
    ...
    parser.add_option('--hein-bound-dir', type=str, default='/u/scr/nlp/data/congress/hein-bound-tokenized-rejoined',
                      help='Issue: default=%default')
    parser.add_option('--hein-daily-dir', type=str, default='/u/scr/nlp/data/congress/hein-daily-tokenized',
                      help='Issue: default=%default')
