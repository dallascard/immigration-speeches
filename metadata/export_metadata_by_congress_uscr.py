...
def main():
    ...
    parser.add_option('--uscr-dir', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/uscr/',
                      help='Issue: default=%default')
    parser.add_option('--people-file', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/uscr-legistlators/legislators-all.json',
                      help='Issue: default=%default')
