...
def main():
    ...
    parser.add_option('--hein-bound-dir', type=str, default='/u/scr/nlp/data/congress/hein-bound/',
                      help='Issue: default=%default')
    parser.add_option('--hein-daily-dir', type=str, default='/u/scr/nlp/data/congress/hein-daily/',
                      help='Issue: default=%default')
