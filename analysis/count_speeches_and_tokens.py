...
# Count non-procedural speeches

def main():
    usage = "%prog"
    parser = OptionParser(usage=usage)
    parser.add_option('--imm-file', type=str, default='/u/scr/nlp/data/congress/predictions/imm_segments_with_tone_and_metadata.jsonlist',
    ...
    parser.add_option('--outdir', type=str, default='/u/scr/nlp/data/congress/immigration/basic_counts/',
