...
def main():
    ...
    parser.add_option('--infile', type=str, default='/u/scr/nlp/data/congress/immigration/predictions/imm_mention_sents_parsed.jsonlist',
    ...
    parser.add_option('--outdir', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/contextual-embeddings/bert-base-uncased/',
                      help='Model name or path: default=%default')
