...
def main():
    ...
    parser.add_option('--infile', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/contextual-embeddings/bert-base-uncased/immigrant_vectors_masked.npz',
    ...
    parser.add_option('--batch-size', type=int, default=256,
                      help='Batch size: default=%default')
    parser.add_option('--outfile', type=str, default='/m-pinotHD/nobackup/dallas/data/congress/contextual-embeddings/bert-base-uncased/immigrant_vectors_maked_all_probs.npz',
                      help='Model name or path: default=%default')
